...
7. **Adopt SLSA Level 3 for production builds.** Hermetic builds, two-party review, signed provenance. The OpenSSF [SLSA framework](https://slsa.dev) gives you the rubric. GitHub Actions has native support via the artifact attestations beta. The EU is about to make most of this list mandatory under the [EU Cyber Resilience Act in 2027](/playbook/expertise/eu-cyber-resilience-act-2027).
