...
<p><strong>AI Chat Assistant</strong> is built on Claude API with RAG over the full FDA/ICH document library. Regulatory specialists ask questions in plain language:</p>
...
<p><strong>Compliance Report</strong> is where the real value sits. Upload your study package, and the system:</p>
...
<p><strong>Onboarding Wizard</strong> configures the analysis for your specific program. You select:</p>
