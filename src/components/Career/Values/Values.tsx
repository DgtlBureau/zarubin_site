...
const VALUES_ITEMS = [
  ...
  },
  {
    title: 'Care',
    description:
      "We care about what's happening on the project and with our clients. We always think about how to make the world around us better. At The Bright Byte, we encourage initiative.",
  },
];
export const Values = () => {
  return (
