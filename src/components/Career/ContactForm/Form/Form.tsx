      ...
      <form className={styles.form} onSubmit={formik.handleSubmit}>
        <label className={styles.label}>
          <input
            ...
            required
            className='w-full resize-none border-b border-blue-600 bg-transparent pb-2 font-inter text-base text-white placeholder-gray-500 placeholder-opacity-50 outline-none focus:bg-blue-950 mobile-big:text-2xl'
        ...
        >
          <div className='flex items-center justify-between'>
            <label
              className={`${formik.values.cv?.name ? 'text-white ' : 'text-gray-500 opacity-50'} font-inter text-base  mobile-big:text-2xl`}
            >
        ...
        <button type='submit' className={`${styles.formBtn} font-inter`}>
          Blue button
        </button>
      </form>
    </div>
