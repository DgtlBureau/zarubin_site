...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      'font-inter text-[22px] font-bold leading-[1.25] mobile-big:text-[32px] mobile-big:leading-[1.14]',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn('font-inter text-[14px] leading-[1.4] tablet:text-[16px]', className)}
    {...props}
  />
));
