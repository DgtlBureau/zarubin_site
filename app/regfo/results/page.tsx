...
export default function ResultsPage() {
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      pdf.setFontSize(8);
      pdf.setTextColor(100, 116, 139);
      pdf.text('Generated by The BrightByte - Compliance Assessment Tool', pageWidth / 2, yPosition, { align: 'center' });
          ...
          <div>
            ...
            <div className="mt-6 bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-6 text-white">
              ...
              <p className="typo-body-sm text-white/80 mb-4">
                The BrightByte provides expert compliance consulting, SOC 2 audit
