...
## Инструкция по добавлению и изменению названия и описания на странице лендинга (bonuses):
...
2. В данном файле будут следующие обязательные данные:
   ...
   3. links - в этом массиве объектов по порорядку сверху сниз находятся данные для статьи: 
          1. name - название статьи/тега; 
          2. link - ссылка, куда будет вести данная статья/тег при клике; 
          3. Если в link оставить значение = '' - значит такой ссылки для статьи/тега нет, и name - будет не активен.
